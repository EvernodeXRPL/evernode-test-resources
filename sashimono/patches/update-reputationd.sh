...
if (! curl "https://raw.githubusercontent.com/$repo_owner/$repo_name/updated-patch/sashimono/patches/resources/reputationd/$file" -o "$REPUTATIOND_BIN/$file") || (! chmod +x "$REPUTATIOND_BIN/$file"); then
