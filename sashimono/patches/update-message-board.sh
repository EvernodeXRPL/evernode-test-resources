...
if (! curl "https://raw.githubusercontent.com/$repo_owner/$repo_name/updated-patch/sashimono/patches/resources/mb-xrpl/$file" -o "$MB_XRPL_BIN/$file") || (! chmod +x "$MB_XRPL_BIN/$file"); then
